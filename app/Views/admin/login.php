...
<div class="login-content">
    <div class="login-form-wrapper">
        <div class="logo-header" style="display: flex; flex-direction: column; align-items: center; gap: 5px; margin-bottom: 2.5rem;">
            ...
            <span class="admin-badge" style="margin-top: 15px;">Secure Admin Panel</span>
        </div>
